...
<html>
    <head>
        ...
        <asset:stylesheet src="gestao.css"/>
...
<!--                         FAMILIAS  HOJE                                                -->
        ...
        <div class="div-chart">
            ...
            <input class="refresh-button fa" type="button" value="&#xf0b0" title="Aplicar filtros e atualizar"
                   onclick='atualiza(this, "${g.createLink( action:'obtemFamiliasAtual')}")'/>
            %{--div + canvas inseridos aqui com jquery--}%
            <script>
                var divChart = getElementos(document.currentScript).divChart;
                divChart.segalimChart = inicializaComponenteChart(${raw(jsonFamiliasAtual)});
            </script>
        </div>
